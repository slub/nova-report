...
Gesamtanzahl an Werten: `r print_n(sum(indexed_records_series_daily$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(indexed_records_series_daily2022$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(indexed_records_series_daily2023$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(indexed_records_series_daily2024$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(indexed_records_series_daily2025$count))`

```{r indexed-records2025-plot, eval=F}
...
```{r indexed-records2025-plot-monthly}
...
Gesamtanzahl an Werten: `r print_n(sum(newitem_records_series_daily$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(newitem_records_series_daily2022$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(newitem_records_series_daily2023$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(newitem_records_series_daily2024$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(newitem_records_series_daily2025$count))`

```{r newitem-records2025-plot, eval=F}
...
```{r newitem-records2025-monthly-plot}
...
Gesamtanzahl an Werten: `r print_n(sum(purchase_records_series_daily$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(purchase_records_series_daily2022$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(purchase_records_series_daily2023$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(purchase_records_series_daily2024$count))`
...
Gesamtanzahl an Werten: `r print_n(sum(purchase_records_series_daily2025$count))`

```{r purchase-records2025-plot, eval=F}
...
```{r purchase-records2025-plot-monthly}
